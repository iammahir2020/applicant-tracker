...
**Rules:** one step at a time. A step is done when every done-when box is ticked *and* the concepts can be explained out loud. Steps can be reordered if it makes teaching sense — say why in `learn.md`.

---

## Current Position

- **Now:** Step 1 — Repo, layout, git
- **Last done:** Step 0 — Planning and ideation (2026-09-01)
- **Next:** Step 2 — TypeScript strict baseline and tooling
...
### [ ] Step 2 — TypeScript strict baseline and tooling
